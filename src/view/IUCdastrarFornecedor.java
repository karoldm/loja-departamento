 ...
 * @author karol
 */
public class IUCdastrarFornecedor extends javax.swing.JDialog {

    /**
     * Creates new form IUCdastrarFornecedor
     */
    public IUCdastrarFornecedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IUCdastrarFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IUCdastrarFornecedor dialog = new IUCdastrarFornecedor(new javax.swing.JFrame(), true);
