 ...
 * @author karol
 */
public class IURelatorioProdutosMaisVendidos extends javax.swing.JDialog {

    /**
     * Creates new form IURelatorioProdutosMaisVendidos
     */
    public IURelatorioProdutosMaisVendidos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IURelatorioProdutosMaisVendidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IURelatorioProdutosMaisVendidos dialog = new IURelatorioProdutosMaisVendidos(new javax.swing.JFrame(), true);
